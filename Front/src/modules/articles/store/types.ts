...
export interface FetchUploadToMedium {
  type: typeof articleTypes.FETCH_UPLOAD_TO_MEDIUM;
  payload: {
    id: string;
  };
}

export interface FetchUploadToGhost {
  type: typeof articleTypes.FETCH_UPLOAD_TO_GHOST;
  payload: {
    id: string;
  };
}
